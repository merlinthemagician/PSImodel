...
DIR=~/c/PSI
OUT=plots/PSIDET_spp${SPP}_spm${SPM}_smp${SMP}_smm${SMM}_bp${BP}_bn${BN}_tend${TEND}
...
plot "< ./psiDet $1 $2 $3 $4 $5 $6" u 1:2 t col(2) w l ls 1, "" u 1:3 t col(3) w l ls 2, "" u 1:4 t col(4) w l ls 3, "" u 1:5 t col(5) w l ls 4, "" u 1:10 not w l ls 5, "" u 1:11 not w l ls 6
